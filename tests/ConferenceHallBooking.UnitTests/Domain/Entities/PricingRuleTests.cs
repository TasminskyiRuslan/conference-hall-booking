...
public class PricingRuleTests
{
    ...
    {
        var rule = new PricingRule(new TimeOnly(8, 0), new TimeOnly(18, 0), 1.5m);
    ...
    {
        var act = () => new PricingRule(new TimeOnly(18, 0), new TimeOnly(8, 0), 1.5m);
    ...
    public void Constructor_WhenEndTimeEqualsStartTime_ShouldThrowInvalidEntityFieldException()
    {
        ...
        var act = () => new PricingRule(time, time, 1.5m);
    ...
    {
        var act = () => new PricingRule(new TimeOnly(8, 0), new TimeOnly(18, 0), 0m);
    ...
    {
        var act = () => new PricingRule(new TimeOnly(8, 0), new TimeOnly(18, 0), -1m);
